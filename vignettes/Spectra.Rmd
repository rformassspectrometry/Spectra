...
- `MsBackendMzR`: this backend keeps only general spectra variables in memory
  ...
  intensity values) from the original MS files on-demand. By a special internal
  encoding of certain spectra variables the memory requirement of this backend
  is further reduced making it suitable to represent also very large MS
  experiments.
