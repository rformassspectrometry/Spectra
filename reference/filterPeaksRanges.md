...
#> Processing:
#>  Filter: remove peaks based on user-provided ranges for 1 variables [Wed Apr  8 06:21:43 2026] 
...
#> Lazy evaluation queue: 1 processing step(s)
#> Processing:
#>  Filter: select peaks based on user-provided ranges for 2 variables [Wed Apr  8 06:21:43 2026] 
length(res)
#> [1] 2
