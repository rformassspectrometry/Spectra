...
#> Processing:
#>  Filter: remove peaks based on user-provided ranges for 1 variables [Fri Apr  3 07:59:17 2026] 
...
#> Lazy evaluation queue: 1 processing step(s)
#> Processing:
#>  Filter: select peaks based on user-provided ranges for 2 variables [Fri Apr  3 07:59:17 2026] 
length(res)
#> [1] 2
